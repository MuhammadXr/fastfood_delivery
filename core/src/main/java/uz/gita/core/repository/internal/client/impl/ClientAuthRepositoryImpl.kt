...
import uz.gita.core.repository.internal.client.ClientAuthRepository
import java.util.concurrent.TimeUnit



internal class ClientAuthRepositoryImpl : ClientAuthRepository {

    private val auth = FireBaseFields.auth
            ...
            .addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    ...
                    user?.let {
                        ...
                        val checkRegister = FireBaseFields.clientData
